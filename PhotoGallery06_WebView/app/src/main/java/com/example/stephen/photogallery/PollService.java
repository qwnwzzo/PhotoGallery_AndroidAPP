...
/**
 * Created by stephen on 16-06-28.
 */
public class PollService extends IntentService{
    ...
    public static void setServiceAlarm(Context context, boolean isOn) {
        ...
        // a request code that you can use to distinguish this PendingIntent form others
        // the Intent object to send
        // a set of flags that I can use to tweak how the PendingIntent is created
        ...
        if (isOn) {
            ...
            // the time interval at which to repeat the alarm
